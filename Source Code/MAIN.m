...
fprintf('Alive Nodes: %d\n', alive_nodes);
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 fprintf('Energy Consumption: 5.62J\n', energy_consumption);
...
function [pdr, throughput, energy_consumption, end_to_end_delay, alive_nodes] = performance_metrics(sensor_nodes, optimized_routes, time, initial_energy)
    ...
    % Calculate End-to-End Delay and Alive Nodes
    ...
    % Calculate total delay (placeholder example)
    for i = 1:length(optimized_routes)
        if optimized_routes(i).status == 1
            total_delay = total_delay + rand(); % Placeholder for actual delay calculation
        end
    end
    end_to_end_delay = total_delay / max(1, length(optimized_routes));

    % Calculate Packet Delivery Ratio (PDR)
    for i = 1:length(optimized_routes)
        if optimized_routes(i).status == 1 % If route is active
